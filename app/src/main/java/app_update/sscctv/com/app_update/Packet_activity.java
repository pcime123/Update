...
public class Packet_activity extends Fragment {
    ...
    private static final String TAG = "App Update[Packet]";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        checkButton = view.findViewById(R.id.packet_check_btn);
        updateButton = view.findViewById(R.id.packet_update_btn);
        message = view.findViewById(R.id.packet_message);
