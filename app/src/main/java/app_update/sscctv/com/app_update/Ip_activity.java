...
public class Ip_activity extends Fragment {

    private static final String UPDATE_CHANNEL = "stable";

    private static final String PACKAGE_LAUNCHER = "net.biyee.onviferenterprise";
    private static final String TAG = "App Update[IP]";
