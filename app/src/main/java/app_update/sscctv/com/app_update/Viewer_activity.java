...
public class Viewer_activity extends Fragment {

    private static final String UPDATE_CHANNEL = "stable";

    private static final String PACKAGE_LAUNCHER = "com.sscctv.seeeyesmonitor";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.activity_viewer, null);
        now_ver = view.findViewById(R.id.viewer_version);
        new_ver = view.findViewById(R.id.viewer_latest);

        checkButton = view.findViewById(R.id.viewer_check_btn);
        updateButton = view.findViewById(R.id.viewer_update_btn);
        message = view.findViewById(R.id.viewer_message);
