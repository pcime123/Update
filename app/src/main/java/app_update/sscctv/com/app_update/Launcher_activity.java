...
public class Launcher_activity extends Fragment {

    private static final String UPDATE_CHANNEL = "stable";

    private static final String PACKAGE_LAUNCHER = "com.sscctv.launcher_tm";
    private static final String TAG = "App Update[Launcher]";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        checkButton = view.findViewById(R.id.launcher_check_btn);
        updateButton = view.findViewById(R.id.launcher_update_btn);
        message = view.findViewById(R.id.launcher_message);
