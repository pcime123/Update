...
public class TDRU_activity extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        checkButton = view.findViewById(R.id.tdru_check_btn);
        updateButton = view.findViewById(R.id.tdru_update_btn);
        message = view.findViewById(R.id.tdru_message);
